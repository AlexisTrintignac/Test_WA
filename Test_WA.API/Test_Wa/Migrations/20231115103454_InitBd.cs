        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomPoste = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Occupation_Emploi_EmploiId",
                        column: x => x.EmploiId,
                        principalTable: "Emploi",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Occupation_Personne_PersonneId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Occupation_EmploiId",
                table: "Occupation",
                column: "EmploiId");

            migrationBuilder.CreateIndex(
                name: "IX_Occupation_PersonneId",
                table: "Occupation",
                column: "PersonneId");
        }
